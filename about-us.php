        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2>Welcome to RentRover, your trusted partner in hassle-free renting solutions!</h2>
            </div>
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="left-content">
              <h4>At RentRover, we believe in simplifying the rental process, whether you’re a property owner or a tenant.</h4>
              <p>Our platform connects property owners with qualified tenants, making renting properties a breeze. With a focus on efficiency, transparency, and customer satisfaction, RentRover is revolutionizing the rental industry.</p>
              <p>Founded on the principles of reliability and innovation, RentRover provides a comprehensive suite of services tailored to meet the diverse needs of our clients. From property listing and tenant screening to lease management and beyond, we are committed to delivering unparalleled support every step of the way.</p>
